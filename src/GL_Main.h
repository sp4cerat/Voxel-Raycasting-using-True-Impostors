...
struct GL_Main
{
	...
	// Texture functions
	int createTexture( unsigned int size_x, unsigned int size_y,int bpp=32, unsigned char* data=0);
	int createFloatTexture( unsigned int size_x, unsigned int size_y,char* data,int elements=1,bool isFloat=true) ;
